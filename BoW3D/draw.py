...
loop_results = np.loadtxt("./results/kitti_"+seq+".txt")
gt = {}
...
for i in np.arange(min_similarity, max_similarity + 0.01, (max_similarity-min_similarity) * 1.0 /100):
    TP = 0 
    P = 0
...
plt.plot(REC, PRE,  "r-o", label = "BOW3D", linewidth=3.0)
